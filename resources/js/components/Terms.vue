...
<p class="pt-5"><b class="bg-orange p-1 text-white">OVERVIEW</b></p>




<p class=MsoNormal><span lang=EN>This website is operated by <b>Anokha Dhaga</b>. Throughout the site, the terms “we”, “us” and
“our” refer to<b> Anokha Dhaga</b>. <b>Anokha Dhaga</b> offers this website, including all
...
<p class=MsoNormal><span lang=EN>By visiting our site and/ or purchasing
...
or contributors of content.</span></p>




<p class=MsoNormal><span lang=EN>Please read these Terms of Service carefully
...
<p class=MsoNormal><span lang=EN>Any new features or tools which are added to
...
<p class=MsoNormal><b class="bg-orange p-1 text-white">SECTION 1 - ONLINE STORE TERMS</b></p>



<p class=MsoNormal><span lang=EN>By agreeing to these Terms of Service, you
...
dependents to use this site.</span></p>


<p class=MsoNormal><span lang=EN>You may not use our products for any illegal
or unauthorized purpose nor may you, in the use of the Service, violate any
laws in your jurisdiction (including but not limited to copyright laws).</span></p>


<p class=MsoNormal><span lang=EN>You must not transmit any worms or viruses or
any code of a destructive nature.</span></p>


<p class=MsoNormal><span lang=EN>A breach or violation of any of the Terms will
result in an immediate termination of your Services.</span></p>




<p class=MsoNormal><b class="bg-orange p-1 text-white">SECTION 2 - GENERAL CONDITIONS</b></p>




<p class=MsoNormal><span lang=EN>We reserve the right to refuse service to
anyone for any reason at any time.</span></p>


<p class=MsoNormal><span lang=EN>You understand that your content (not
...
information is always encrypted during transfer over networks.</span></p>


<p class=MsoNormal><span lang=EN>You agree not to reproduce, duplicate, copy,
...
is provided, without express written permission by us.</span></p>


<p class=MsoNormal><span lang=EN>The headings used in this agreement are
...
<p class=MsoNormal><b class="bg-orange p-1 text-white">SECTION 3 - ACCURACY, COMPLETENESS AND
TIMELINESS OF INFORMATION</b></p>




<p class=MsoNormal><span lang=EN>We are not responsible if information made
...
reliance on the material on this site is at your own risk.</span></p>


<p class=MsoNormal><span lang=EN>This site may contain certain historical
...
<p class=MsoNormal><b class="bg-orange p-1 text-white">SECTION 4 - MODIFICATIONS TO THE SERVICE AND
PRICES</b></p>


<p class=MsoNormal><span lang=EN>Prices for our products are subject to change
without notice.</span></p>


<p class=MsoNormal><span lang=EN>We reserve the right at any time to modify or
discontinue the Service (or any part or content thereof) without notice at any
time.</span></p>


<p class=MsoNormal><span lang=EN>We shall not be liable to you or to any
third-party for any modification, price change, suspension or discontinuance of
the Service.</span></p>



<p class=MsoNormal><b class="bg-orange p-1 text-white">SECTION 5 - PRODUCTS OR SERVICES</b></p>


<p class=MsoNormal><span lang=EN>Certain products or services may be available
...
<p class=MsoNormal><span lang=EN>We have made every effort to display as
...
<p class=MsoNormal><span lang=EN>We reserve the right, but are not obligated,
...
on this site is void where prohibited.</span></p>


<p class=MsoNormal><span lang=EN>We do not warrant that the quality of any
...
<p class=MsoNormal><b class="bg-orange p-1 text-white">SECTION 6 - ACCURACY OF BILLING AND ACCOUNT
INFORMATION</b></p>




<p class=MsoNormal><span lang=EN>We reserve the right to refuse any order you
...
<p class=MsoNormal><span lang=EN>You agree to provide current, complete and
...
complete your transactions and contact you as needed.</span></p>




<p class=MsoNormal><span lang=EN>For more detail, please review our Returns
Policy.</span></p>




<p class=MsoNormal><b class="bg-orange p-1 text-white">SECTION 7 - OPTIONAL TOOLS</b></p>



<p class=MsoNormal><span lang=EN>We may provide you with access to third-party
tools over which we neither monitor nor have any control nor input.</span></p>


<p class=MsoNormal><span lang=EN>You acknowledge and agree that we provide
...
third-party tools.</span></p>


<p class=MsoNormal><span lang=EN>Any use by you of optional tools offered through
...
the relevant third-party provider(s).</span></p>


<p class=MsoNormal><span lang=EN>We may also, in the future, offer new services
...
<p class=MsoNormal><b class="bg-orange p-1 text-white">SECTION 8 - THIRD-PARTY LINKS</b></p>



<p class=MsoNormal><span lang=EN>Certain content, products and services
available via our Service may include materials from third-parties.</span></p>


<p class=MsoNormal><span lang=EN>Third-party links on this site may direct you
...
websites, or for any other materials, products, or services of third-parties.</span></p>


<p class=MsoNormal><span lang=EN>We are not liable for any harm or damages
...
<p class=MsoNormal><b class="bg-orange p-1 text-white">SECTION 9 - USER COMMENTS, FEEDBACK AND OTHER
SUBMISSIONS</b></p>




<p class=MsoNormal><span lang=EN>If, at our request, you send certain specific
...
respond to any comments.</span></p>


<p class=MsoNormal><span lang=EN>We may, but have no obligation to, monitor,
...
<p class=MsoNormal><span lang=EN>You agree that your comments will not violate
...
<p class=MsoNormal><b class="bg-orange p-1 text-white">SECTION 10 - PERSONAL INFORMATION</b></p>




<p class=MsoNormal><span lang=EN>Your submission of personal information
through the store is governed by our Privacy Policy. </span></p>




<p class=MsoNormal><b class="bg-orange p-1 text-white">SECTION 11 - ERRORS, INACCURACIES AND
OMISSIONS</b></p>




<p class=MsoNormal><span lang=EN>Occasionally there may be information on our
...
you have submitted your order).</span></p>


<p class=MsoNormal><span lang=EN>We undertake no obligation to update, amend or
...
<p class=MsoNormal><b class="bg-orange p-1 text-white">SECTION 12 - PROHIBITED USES</b></p>




<p class=MsoNormal><span lang=EN>In addition to other prohibitions as set forth
in the Terms of Service, you are prohibited from using the site or its content:
...
<p class=MsoNormal><b class="bg-orange p-1 text-white">SECTION 13 - DISCLAIMER OF WARRANTIES;
LIMITATION OF LIABILITY</b></p>




<p class=MsoNormal><span lang=EN>We do not guarantee, represent or warrant that
your use of our service will be uninterrupted, timely, secure or error-free.</span></p>


<p class=MsoNormal><span lang=EN>We do not warrant that the results that may be
obtained from the use of the service will be accurate or reliable.</span></p>


<p class=MsoNormal><span lang=EN>You agree that from time to time we may remove
the service for indefinite periods of time or cancel the service at any time,
without notice to you.</span></p>


<p class=MsoNormal><span lang=EN>You expressly agree that your use of, or
...
durability, title, and non-infringement.</span></p>


<p class=MsoNormal><span lang=EN>In no case shall <b>Anokha Dhaga</b>, our directors, officers, employees, affiliates, agents,
...
<p class=MsoNormal><b class="bg-orange p-1 text-white">SECTION 14 - INDEMNIFICATION</b></p>




<p class=MsoNormal><span lang=EN>You agree to indemnify, defend and hold
harmless <b>Anokha Dhaga </b>and our parent,
...
any law or the rights of a third-party.</span></p>




<p class=MsoNormal><b class="bg-orange p-1 text-white">SECTION 15 - SEVERABILITY</b></p>




<p class=MsoNormal><span lang=EN>In the event that any provision of these Terms
...
enforceability of any other remaining provisions.</span></p>




<p class=MsoNormal><b class="bg-orange p-1 text-white">SECTION 16 - TERMINATION</b></p>




<p class=MsoNormal><span lang=EN>The obligations and liabilities of the parties
incurred prior to the termination date shall survive the termination of this
agreement for all purposes.</span></p>


<p class=MsoNormal><span lang=EN>These Terms of Service are effective unless
...
Services, or when you cease using our site.</span></p>


<p class=MsoNormal><span lang=EN>If in our sole judgment you fail, or we
...
any part thereof).</span></p>




<p class=MsoNormal><b class="bg-orange p-1 text-white">SECTION 17 - ENTIRE AGREEMENT</b></p>




<p class=MsoNormal><span lang=EN>The failure of us to exercise or enforce any
right or provision of these Terms of Service shall not constitute a waiver of
such right or provision.</span></p>


<p class=MsoNormal><span lang=EN>These Terms of Service and any policies or
...
<p class=MsoNormal><span lang=EN>Any ambiguities in the interpretation of these
Terms of Service shall not be construed against the drafting party.</span></p>




<p class=MsoNormal><b class="bg-orange p-1 text-white">SECTION 18 - GOVERNING LAW</b></p>




<p class=MsoNormal><span lang=EN>These Terms of Service and any separate
agreements whereby we provide you Services shall be governed by and construed
in accordance with the laws of India and jurisdiction of Ahmedabad, Gujarat</span></p>




<p class=MsoNormal><b class="bg-orange p-1 text-white">SECTION 19 - CHANGES TO TERMS OF SERVICE</b></p>




<p class=MsoNormal><span lang=EN>You can review the most current version of the
Terms of Service at any time at this page.</span></p>


<p class=MsoNormal><span lang=EN>We reserve the right, at our sole discretion,
...
<p class=MsoNormal><b class="bg-orange p-1 text-white">SECTION 20 - CONTACT INFORMATION</b></p>




<p class=MsoNormal><span lang=EN>Questions about the Terms of Service should be
sent to us at <b>anokhadhaga@gmail.com</b>.</span></p>
