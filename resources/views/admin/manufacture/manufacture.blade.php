  ...
  <div class="content-wrapper">
    ...
    <div class="content-header">
      <div class="container-fluid">
        <div class="row mb-2">
          <div class="col-sm-6">
            <h1 class="m-0 text-dark">Festival Add/Update</h1>
          </div><!-- /.col -->
          <div class="col-sm-6">
            <ol class="breadcrumb float-sm-right">
              <li class="breadcrumb-item"><a href="#">Home</a></li>
              <li class="breadcrumb-item active">Add/update Festival</li>
            </ol>
          </div><!-- /.col -->
            ...
            <div class="col-md-6 col-lg-6">
              <div class="card shadow mt-3 mb-5">
                <div class="card-header">
                  <h5 class="text-center">Add Manufacture</h5>
                </div>
                <div class="card-body">
...
<script>
  ...
  $('.select2bs4').on('click',function(){
    $.ajaxSetup({
      ...
      $.ajax({
        url:"/manufactureValGet",
        method:"post",
        data:{
          id:id
        },
        success:function(response){
            $('#delete').removeClass('disabled').attr('href','/deleteManufacture/'+response.id+'');
        //   console.log(response);
          $('#manuId').val(response.id);
    ...
    $('#add').on('click', function(){
        $('#addBlade').append('<div class="form-group"><input type="text" class="form-control" name="blade[]" placeholder="Enter Blade File Name" checked></div>');
    });
    $('#remove').on('click', function(){
        $('#addBlade').children().last().remove();
    });
</script>
