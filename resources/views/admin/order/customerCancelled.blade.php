                ...
                <div class="card-body p-0 table-responsive">
                  <table class="table table-light" style="width: 100%">
                    ...
                    <tbody>
                      ...
                      <tr>
                        ...
                        <td class="btn-group">
                          @if($order->orderstatus_id == 6)
                            <a href="#" class="btn btn-success btn-sm disabled mr-1">Approve</a>
                            <a href="#" class="btn btn-danger btn-sm disabled mr-1">Disapprove</a>
                          @else 
                      ...
                      @empty
                        <tr>
                            <td class="text-center" colspan="6">No cancel orders found</td>
                        </tr>
                      @endforelse
                  </tbody>
                </table>
