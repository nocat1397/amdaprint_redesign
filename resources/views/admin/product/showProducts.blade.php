                        ...
                        <td>
                          ...
                          <div class="btn-group">
                            ...
                            <div class="dropdown-menu" style="">
                              ...
                              <a class="dropdown-item" type="button" href="javascript:void(0)" data-toggle="modal" data-target="#duplicate{{$key}}{{$index}}"><img src="data:image/png;base64," style="height: fit-content;width: 20px;margin-right: 6px;">Clone Product</a>
                          ...
                          <div class="modal fade" id="duplicate{{$key}}{{$index}}" tabindex="-1" role="dialog" aria-labelledby="exampleModalCenterTitle" aria-hidden="true">
                            <div class="modal-dialog modal-dialog-centered" role="document">
                              <div class="modal-content">
                                <div class="modal-header bg-dark">
                                  <h5 class="modal-title" id="exampleModalLongTitle">Clone Product</h5>
                                  <button type="button" class="close" data-dismiss="modal" aria-label="Close">
                                    <span aria-hidden="true">&times;</span>
                                  </button>
                                </div>
                                <div class="modal-body">
                                  <form action="/clone-product" method="POST">
                                    @csrf
                                    <input type="hidden" name="product_index" value="{{$index}}">
                                    <input type="hidden" name="product_id" value="{{$category->product['id']}}">
                                    <input type="hidden" name="category_id" value="{{$category->id}}">
                                    ...
                                    <div class="form-group">
                                      <input type="text" name="name" class="form-control" required placeholder="This name will appear in cloned product">
                                    </div>
                                    <div class="btn-group">
