                                ...
                                <div class="card shadow">
                                    ...
                                    <div class="card-body">
                                        ...
                                        <form action="/registerUser" method="POST">
                                            ...
                                            <div class="form-group">
                                                <button class="addtocart_btn custom_btn bg_default_orange" type="submit">Register</button>
                                                <a href="/user/login" class="float-right">Existing user?</a>
                                            </div>
                                        </form>
                                    </div>
                                </div>
