								...
								<div class="row justify-content-center">
									<div class="col-lg-4 col-md-4 col-sm-6 col-xs-12 wow fadeInUp2" data-wow-delay=".1s">
										<div class="product_card text-center">
											<a class="item_image" target="_blank" href="/business-cards/premium-business-cards/raised-uv-business-card">
												<img src="/assets/images/details/shop/bCards/Raised_Business_Cards.jpg" alt="image_not_found">
											</a>
											<div class="item_content">
												<h3 class="item_title">Raised UV Business Card</h3>
									...
									<div class="col-lg-4 col-md-4 col-sm-6 col-xs-12 wow fadeInUp2" data-wow-delay=".3s">
										<div class="product_card text-center">
											<a class="item_image" target="_blank" href="/business-cards/premium-business-cards/raised-foils-business-card">
												<img src="/assets/images/details/shop/bCards/Raise-Gold-Foil.jpg" alt="image_not_found">
											</a>
											<div class="item_content">
												<h3 class="item_title">Raised Folis Business Card</h3>
												<span class="item_price"></span>
											</div>
										</div>
									</div>
