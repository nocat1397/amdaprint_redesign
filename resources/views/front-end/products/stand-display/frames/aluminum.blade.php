								...
								<div class="details_image clearfix">
									<div class="tab-content">
										<div id="image_1" class="tab-pane active">
											<img src="/assets/images/details/shop/StandsDisplay/Frames/aluminium/1.jpg" alt="image_not_found">
										</div>
										<div id="image_2" class="tab-pane fade">
											<img src="/assets/images/details/shop/StandsDisplay/Frames/aluminium/2.jpg" alt="image_not_found">
										</div>
										<div id="image_3" class="tab-pane fade">
											<img src="/assets/images/details/shop/StandsDisplay/Frames/aluminium/3.jpg" alt="image_not_found">
										</div>
									</div>
                                            ...
                                            <div class="form-row mb-3">
                                                ...
                                                <div class="col form-inline">
                                                    <select class="mr-2 w-50" id="bannerSize">
                                                        <option selected value="792">24 x 33 Feet</option>
                                                    </select>
                                                </div>
