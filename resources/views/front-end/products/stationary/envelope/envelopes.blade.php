								...
								<div class="row justify-content-center">
									<div class="col-lg-4 col-md-4 col-sm-6 col-xs-12 wow fadeInUp2" data-wow-delay=".1s">
										<div class="product_card text-center">
											<a class="item_image" target="_blank" href="/office-stationary/envelopes/10-envelope">
												<img src="/assets/images/details/shop/envelope/10_Envelopes.jpg" alt="image_not_found">
											</a>
											<div class="item_content">
												<h3 class="item_title"> #10 Envelopes </h3>
									...
									<div class="col-lg-4 col-md-4 col-sm-6 col-xs-12 wow fadeInUp2" data-wow-delay=".3s">
										<div class="product_card text-center">
											<a class="item_image" target="_blank" href="/office-stationary/envelopes/a6-envelope">
												<img src="/assets/images/details/shop/envelope/A6_Envelopes.jpg" alt="image_not_found">
											</a>
											<div class="item_content">
												<h3 class="item_title">A6 Envelopes</h3>
												<span class="item_price"></span>
											</div>
										</div>
									</div>
									...
									<div class="col-lg-4 col-md-4 col-sm-6 col-xs-12 wow fadeInUp2" data-wow-delay=".5s">
										<div class="product_card text-center">
											<a class="item_image" target="_blank" href="/office-stationary/envelopes/9x12-envelope">
												<img src="/assets/images/details/shop/envelope/9x12_Envelopes.jpg" alt="image_not_found">
											</a>
											<div class="item_content">
												<h3 class="item_title">9 X 12 Envelopes</h3>
												<span class="item_price"></span>
											</div>
										</div>
									</div>
									<div class="col-lg-4 col-md-4 col-sm-6 col-xs-12 wow fadeInUp2" data-wow-delay=".5s">
										<div class="product_card text-center">
											<a class="item_image" target="_blank" href="/office-stationary/envelopes/9-envelope">
												<img src="/assets/images/details/shop/envelope/9_Envelopes.jpg" alt="image_not_found">
											</a>
											<div class="item_content">
												<h3 class="item_title">#9 enelope</h3>
												<span class="item_price"></span>
											</div>
										</div>
									</div>
									<div class="col-lg-4 col-md-4 col-sm-6 col-xs-12 wow fadeInUp2" data-wow-delay=".5s">
										<div class="product_card text-center">
											<a class="item_image" target="_blank" href="/office-stationary/envelopes/a2-envelope">
												<img src="/assets/images/details/shop/envelope/A2_Envelopes.jpg" alt="image_not_found">
											</a>
											<div class="item_content">
												<h3 class="item_title">A2 envelopes	</h3>
												<span class="item_price"></span>
											</div>
										</div>
									</div>
									<div class="col-lg-4 col-md-4 col-sm-6 col-xs-12 wow fadeInUp2" data-wow-delay=".5s">
										<div class="product_card text-center">
											<a class="item_image" target="_blank" href="/office-stationary/envelopes/a7-envelope">
												<img src="/assets/images/details/shop/envelope/A7_Envelopes.jpg" alt="image_not_found">
											</a>
											<div class="item_content">
												<h3 class="item_title">A7 Envelopes</h3>
												<span class="item_price"></span>
											</div>
										</div>
									</div>
									<div class="col-lg-4 col-md-4 col-sm-6 col-xs-12 wow fadeInUp2" data-wow-delay=".5s">
										<div class="product_card text-center">
											<a class="item_image" target="_blank" href="/office-stationary/envelopes/6x9-envelope">
												<img src="/assets/images/details/shop/envelope/6x9_Envelopes.jpg" alt="image_not_found">
											</a>
											<div class="item_content">
												<h3 class="item_title">6 X 9 Envelopes</h3>
												<span class="item_price"></span>
											</div>
										</div>
									</div>
