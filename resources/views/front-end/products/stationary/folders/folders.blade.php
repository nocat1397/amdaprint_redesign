					...
					<div class="row justify-content-lg-between justify-content-md-center justify-content-sm-center">
						...
						<div class="col-lg-10 col-md-12 order-last">
							...
							<div class="row justify-content-center">
								<div class="col-lg-3 col-md-3 col-sm-6 col-xs-12 wow fadeInUp2" data-wow-delay=".1s">
									<div class="product_card text-center">
										<a class="item_image" target="_blank" href="/office-stationary/folders/large-folders">
											<img src="/assets/images/details/shop/folders/large/1.jpg" alt="image_not_found">
										</a>
										<div class="item_content">
											<h3 class="item_title">Large Folders</h3>
											<span class="item_price"></span>
										</div>
									</div>
								</div>

								<div class="col-lg-3 col-md-3 col-sm-6 col-xs-12 wow fadeInUp2" data-wow-delay=".3s">
									<div class="product_card text-center">
										<a class="item_image" target="_blank" href="/office-stationary/folders/mini-folders">
											<img src="/assets/images/details/shop/folders/mini/1.jpg" alt="image_not_found">
										</a>
										<div class="item_content">
											<h3 class="item_title">Mini Folders</h3>
											<span class="item_price"></span>
										</div>
									</div>
								</div>

								<div class="col-lg-3 col-md-3 col-sm-6 col-xs-12 wow fadeInUp2" data-wow-delay=".5s">
									<div class="product_card text-center">
										<a class="item_image" target="_blank" href="/office-stationary/folders/key-card-holder">
											<img src="/assets/images/details/shop/folders/key/1.jpg" alt="image_not_found">
										</a>
										<div class="item_content">
											<h3 class="item_title">Key Card Holder</h3>
											<span class="item_price"></span>
										</div>
									</div>
								</div>
