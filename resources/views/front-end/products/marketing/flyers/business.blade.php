								...
								<div class="details_image clearfix">
									<div class="tab-content">
										...
										<div id="image_2" class="tab-pane fade">
											<img src="/assets/images/details/shop/marketing/flyers/business/2.jpg" alt="image_not_found">
										</div>
										<div id="image_3" class="tab-pane fade">
											<img src="/assets/images/details/shop/marketing/flyers/business/3.jpg" alt="image_not_found">
										</div>
									...
									<div id="details_form">
                                        <form action="" class="productForm">
                                            ...
                                            <div class="form-row mb-3">
                                                <div class="col-md-3">
                                                    <label class="my-1 mr-2">Size (before folding)</label>
                                                </div>
                                            ...
                                            <div class="form-row mb-3" id="">
                                                ...
                                                <div class="col-md-6">
													<select class="w-100" id="bannerAdd">
														<option selected value="0">80 lb. Paper Gloss</option>
                                                        <option value="1">100 lb. Paper Gloss</option>
                                                        <option value="1">100 lb. Paper Matte</option>
                                                    </select>
                                                </div>
											...
											<div class="form-row mb-3" id="">
                                                ...
                                                <div class="col-md-6">
                                                    <select class="w-100" id="bannerAdd">
                                                        ...
                                                        <option value="1">Tri Fold/Letter Fold</option>
                                                    </select>
                                                </div>
												<div class="col-md-3">
													<label id="bannerAddAmount" class="text-danger font-weight-bold">$<span></span></label>
											...
											<div class="form-row mb-3" id="">
												<div class="col-md-3">
													<label class="my-1 mr-2">In Set Of</label>
                                                </div>
