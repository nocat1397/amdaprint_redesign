							...
							<div class="row justify-content-center">
								<div class="col-lg-4 col-md-4 col-sm-6 col-xs-12 wow fadeInUp2" data-wow-delay=".1s">
									<div class="product_card text-center">
										<a class="item_image" target="_blank" href="/marketing-essentials/flyers/club-flyers">
											<img src="/assets/images/details/shop/marketing/flyers/club/1.jpg" alt="image_not_found">
										</a>
										<div class="item_content">
											<h3 class="item_title">Club Flyers</h3>
								...
								<div class="col-lg-4 col-md-4 col-sm-6 col-xs-12 wow fadeInUp2" data-wow-delay=".3s">
									<div class="product_card text-center">
										<a class="item_image" target="_blank" href="/marketing-essentials/flyers/business-flyers">
											<img src="/assets/images/details/shop/marketing/flyers/business/1.jpg" alt="image_not_found">
										</a>
										<div class="item_content">
											<h3 class="item_title">Business Flyers</h3>
											<span class="item_price"></span>
										</div>
									</div>
								</div>
								...
								<div class="col-lg-4 col-md-4 col-sm-6 col-xs-12 wow fadeInUp2" data-wow-delay=".5s">
									<div class="product_card text-center">
										<a class="item_image" target="_blank" href="/marketing-essentials/flyers/die-cut-flyers">
											<img src="/assets/images/details/shop/marketing/flyers/die/1.jpg" alt="image_not_found">
										</a>
										<div class="item_content">
											<h3 class="item_title">Die-Cut Flyers</h3>
											<span class="item_price"></span>
										</div>
									</div>
								</div>
